...
const getManyHOR = require("./getManyHOR");
const addOneHOR = require("./addOneHOR");
const getOneHOR = require("./getOneHOR");
const removeOneHOR = require("./removeOneHOR");
const updateOneHOR = require("./updateOneHOR");
